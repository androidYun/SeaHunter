...
class ClubMatchResultActivity : BaseActivity(), ChannelContact.IChannelView {
    private val nChannelModelReq = NChannelModelReq(
        channel_name = ChannelEnum.game.name
    )
    ...
    private fun initView() {
        ...
        rvSearchResult.adapter = mClubMatchAdapter
    }

...
import com.sea.publicmodule.api.UserInformApi


class UserInformPresenter : IPresenter<UserInformContact.IUserInformView>(),
    UserInformContact.IUserInformPresenter {

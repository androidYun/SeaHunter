package com.sea.publicmodule.activity.web
...
import kotlinx.android.synthetic.main.fragment_content_web.*
...
class WebContentFragment : BaseFragment() {
    ...
    private val webContent by lazy { arguments?.getString(web_content_key) ?: "" }
    ...
    private fun initData() {
        webView.loadDataWithBaseURL("",varjs +webContent, "text/html", "UTF-8","")
    }
    ...
    companion object {
        ...
        fun getInstance( webContent: String) = WebContentFragment().apply {
            arguments = Bundle().apply {
                putString(web_content_key, webContent)
            }
        }
    }
}
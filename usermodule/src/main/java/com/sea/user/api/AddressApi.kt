...
import com.sea.user.activity.address.NDeleteAddressModelReq
...
interface AddressApi {
    ...
    @POST("getdata.ashx")
    fun loadDeleteAddAddress(@Body nDeleteAddressModelReq: NDeleteAddressModelReq): Observable<BaseEntry>

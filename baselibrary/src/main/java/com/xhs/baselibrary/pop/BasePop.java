...
public class BasePop extends PopupWindow {
    ...
    */
    public static class Builder {
        ...
        /**
         * 设置点击事件
         * @param _onClickListener - 事件回调
         */
        public Builder setOnClickEvent(final OnEventListener.OnBaseClickListener _onClickListener){
         ...
         * @return
         */
        public Builder setOnDissmiss(final OnEventListener.OnBaseListener _onBaseListener){
            if (null != basePop){
                basePop.setOnDismissListener(() -> {
                    if (null != _onBaseListener){
                        _onBaseListener.onDismiss();
                    }
                });
            }
            return this;
